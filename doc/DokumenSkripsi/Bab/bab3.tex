...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.7]{Gambar/DaringMahasiswa.jpg}
...
\begin{enumerate}
	...
	\end{figure}
	Jawaban dari 6 orang responden adalah mulai dari waktu paling cepat 1 detik hingga waktu paling lama 120 detik. Hal tersebut dapat dilihat pada Gambar \ref{fig:DaringDosen}.\\ \\
	\begin{tabular}{|p{4cm} |p{7cm}|}
		\hline
		Jumlah Responden &  Waktu Perekaman Kehadiran Daring \\ \hline     
	...
	\end{figure}
	Jawaban dari 6 orang responden adalah mulai dari waktu paling cepat 1 detik hingga waktu paling lama 90 detik.Hal tersebut dapat dilihat pada Gambar \ref{fig:LuringDosen}.\\ \\
	\begin{tabular}{|p{4cm} |p{7cm}|}
		\hline
		Jumlah Responden &  Waktu Perekaman Kehadiran Luring \\ \hline     
		1 orang &  1 detik\\ \hline 
